		...
		getWeek(dateData) {
			...
			for (let i = 1; i <= new Date(year, month, 0).getDate(); i++) {
				...
				for (let j = 0; j < selected.length; j++) {
					...
					let selDate = selected[j].addTime.split("-");
					// console.log(Number(year) + "      1       " + Number(selDate[0]));
					// console.log(Number(month) + "     2         " + Number(selDate[1]));
					// console.log(Number(i) + "          3        " + Number(selDate[2]));
					if (
